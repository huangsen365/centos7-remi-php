...
RUN yum -y install $(cat /tmp/somefiles/yum_search_php_extensions_list_php70_defined2.txt)
RUN yum -y install $(cat /tmp/somefiles/yum_search_php_extensions_list_php71_defined2.txt)
RUN yum -y install $(cat /tmp/somefiles/yum_search_php_extensions_list_php72_defined2.txt)
RUN yum -y install $(cat /tmp/somefiles/yum_search_php_extensions_list_php73_defined2.txt)
RUN yum -y install $(cat /tmp/somefiles/yum_search_php_extensions_list_php74_defined2.txt)
